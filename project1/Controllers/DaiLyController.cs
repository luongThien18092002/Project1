...
namespace project1.Controllers
{
    public class DaiLyController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MaHTPP,MaDaiLy,TenDaiLy,DiaChia,NguoiDaiDien,DienThoai,TenHTPP")] DaiLy daiLy)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("MaHTPP,MaDaiLy,TenDaiLy,DiaChia,NguoiDaiDien,DienThoai,TenHTPP")] DaiLy daiLy)
        {
            if (id != daiLy.MaHTPP)
            {
                return NotFound();
